...
(function (g, k) {
  ...
  var b = {
      ...
      closest: function (a, c) {
        return (
          a && a !== document.body && (c(a) ? a : b.closest(a.parentNode, c))
        );
      },
      isInt: function (a) {
          ...
          function (a, c) {
            "OPTGROUP" === c.nodeName
              ? ((e = b.createElement("ul", {
                  ...
                  role: "group",
                  html:
                    "<li class='selectr-optgroup--label'>" + c.label + "</li>",
                })),
                b.each(
                  c.children,
                  function (a, b) {
            ...
            k(c, "children")
              ? ((f = b.createElement("optgroup", { label: c.text })),
                (e = b.createElement("ul", {
                  ...
                  role: "group",
                  html:
                    "<li class='selectr-optgroup--label'>" + c.text + "</li>",
                })),
                b.each(
                  c.children,
                  function (a, b) {
              ...
              : ((h = new Option(
                  ...
                  c.value,
                  !1,
                  c.hasOwnProperty("selected") && !0 === c.selected
                )),
    ...
    x = function (a) {
      ...
      c &&
        (this.label.removeChild(c), this.tags.splice(this.tags.indexOf(c), 1));
    },
    r = function () {
      var a = this.tree;
      if (
    ...
    if (this.config.nativeKeyboard) {
      ...
      this.selected.addEventListener("keydown", function (b) {
        if (
          ...
          if (
            " " === b.key ||
            (!a.opened && -1 < ["Enter", "ArrowUp", "ArrowDown"].indexOf(b.key))
          )
    ...
    this.tree.addEventListener("click", function (c) {
      ...
      d &&
        ...
        (b.hasClass(d, "selected")
          ? (a.el.multiple || (!a.el.multiple && a.config.allowDeselect)) &&
            a.deselect(d.idx)
          : a.select(d.idx),
          ...
          if (13 === c.which || b.includes(a.tagSeperators, c.key))
            b.each(a.tagSeperators, function (a, b) {
              ...
              a.add(
                ...
                ? (a.close(), q.call(a))
                : ((this.value = ""),
                  a.setMessage(a.config.messages.tagDuplicate));
        }
      });
  ...
  g.prototype.removeAll = function () {
    ...
    this.navIndex = 0;
    this.requiresPagination &&
      ((this.requiresPagination = !1), (this.pageIndex = 1), (this.pages = []));
    this.setPlaceholder();
  };
              ...
              if (
                ...
                var l = (l = new RegExp(a, "i").exec(h.textContent))
                  ? h.textContent.replace(
                      l[0],
                      "<span class='selectr-match'>" + l[0] + "</span>"
                    )
                  : !1;
                k.innerHTML = l;
              }
  ...
  g.prototype.close = function () {
    ...
    if (this.mobileDevice || this.config.nativeDropdown)
      ...
      this.config.searchable &&
        !a &&
        (this.input.blur(), (this.input.tabIndex = -1), (this.searching = !1));
      a &&
        (b.removeClass(this.container, "notice"),
